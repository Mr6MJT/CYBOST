...
clear
sleep 0.5
printf "$WHITE Running $RED CYBOST tool..."
sleep 3
clear
sleep 0.5
clear
...
sleep 0.5
sudo apt-get install nasm > /dev/null 2>&1
sudo apt-get install sox > /dev/null 2>&1
sudo apt-get install sox libsox-fmt-all > /dev/null 2>&1
sleep 5
clear
