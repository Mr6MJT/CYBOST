# I stole the code of the colors from my friend mahmoud ossman :)
# follow him please https://github.com/Mahmoud7Osman
...
printf "$RED ☢ mal:         $WHITE Generate Malware.\n"
printf "$RED ☢ ports:       $WHITE Check Open ports.\n"
printf "$RED ☢ ddos:        $WHITE Ddos attack.\n"
#printf "$RED ☢ 
printf "$RED ☢ cwyfo:       $WHITE Chat With Your Friends Online.\n"
...
printf "$RED ☢ chat:        $WHITE Chat with robot.\n"
printf "$RED ☢ h4cker:      $WHITE Make the codes moving on the screen.\n"
printf "$RED ☢ music:       $WHITE play Music that help you to study.\n"
...
#elif [ $m == "comp" ]
#then
#	printf "$RED ☢ Move the files to cybost directory.\n"
#	sleep 1
#	printf "$RED ☢ enter the number of the files you want to compress: \n"
#	printf "$WHITE ─[$USER]─[CYBOST]$RED ─╼>$ "
#	read filenb
#	dd=0
#	while [ $dd -ne $filenb ]
#	do
#		printf "$RED ☢ Enter the $dd-filename: \n"
#		printf "$WHITE ─[$USER]─[CYBOST]$RED ─╼>$ "
#		read 1$dd
#		((dd=dd+1))
#	done
