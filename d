...
printf "$RED ☢ ports:       $WHITE Check Open ports by my software (Delta).\n"
printf "$RED ☢ comp:        $WHITE Compile c++ and c files to exe\n"
printf "$RED ☢ chat:        $WHITE Chat With Your Friends Online by my software (HodHod).\n"
...
printf "$RED ☢ dns:         $WHITE Dns lookup.\n"
printf "$RED ☢ mjtio:       $WHITE Print the source code of mjtio.asm header.\n"
printf "$RED ☢ delf:        $WHITE Delete file more securly to hide data from Digital forensics investigation.\n"
printf "$RED ☢ DtoB:        $WHITE Change decimal to binary.\n"
printf "$RED ☢ h4cker:      $WHITE Become hacker like a movies.\n"
...
then
	cd .. && rm -r CYBOST && git clone https://github.com/Mr6MJT/CYBOST && cd ..
elif [ $m == "chat" ]
then
	pl
